...
export const ProductoUpdateSchema = z.object({
  nombre: z.string().min(3, "Error minimo 3 caracteres").optional(),
  precio_compra: z.number().min(1000, "Error precio minimo $1.000").optional(),
  stock: z.number().min(1, "Error minimo 1").optional(),
